...
const OTPScreen = ({navigation}) => {
  ...
  //     console.log("current state " + otpExpired);
  //     if(otpExpired === false){
  //       toggleExpired();
  //       console.log("State changed " + otpExpired );
  //     }
  ...
  const handleSubmit = async () => {
    ...
    try {
      console.log(`${baseUrl}/validate/reset/password/otp`);

      const response = await fetch(`${baseUrl}/validate/reset/password/otp`, {
        method: "POST",
        headers: {
